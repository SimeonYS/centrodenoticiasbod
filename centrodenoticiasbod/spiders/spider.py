...
class CcentrodenoticiasbodSpider(scrapy.Spider):
	name = 'centrodenoticiasbod'
	start_urls = ['http://centrodenoticiasbod.com.ve/category/noticias/',
				  'http://centrodenoticiasbod.com.ve/category/noticias-ccbod/']
